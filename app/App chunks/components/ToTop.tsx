...
const ToTop = () => {
  ...
  return (
    <AnimatePresence>
      {isBtnShown && (
        <motion.button
          className="px-4 fixed shadow-lg z-[9999999999999] group w-40 h-10 font-Satoshi right-10 bottom-5 overflow-hidden py-2 bg-black text-slate-50 rounded-full hover:bg-gray-950"
          onClick={scrollToTop}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
